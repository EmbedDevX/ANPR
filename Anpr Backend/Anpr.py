...
class Anpr_Class:
    ...
    def __init__(self, tcp_ip,tcp_port, camera_location, db_servername, db_username, db_password, db_name,redis_host,redis_port,cnxn=0):
        self.tcp_ip = tcp_ip
        ...
        while True :
            try :
                ...
                print("something's wrong with data base  with exception message" + str(e))
        ...
        while True :
            try :
                ...
                print("Something error occured" + str(e))
        ...
        while True :
            try :
                connection = redis.Redis(self.redis_host,self.redis_port,db=0)
                connection.ping()
